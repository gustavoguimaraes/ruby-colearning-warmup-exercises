...
#
  ...
  it "it test which class the element has" do
    kitchen.add("stove") 
    kitchen.add("windows")
    kitchen.puts_class.

    expect(kitchen.puts_class).to eq [String, String]
  end
#
...
#  end
  ...
  it "creates arrays out of each element" do
    kitchen.add("stove")
    kitchen.add("windows")
    kitchen.make_mini_arrays
    expect(kitchen.make_mini_arrays).to eq [["stove"], ["windows"]]
  end
